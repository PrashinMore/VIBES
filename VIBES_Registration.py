...
def outside_program():
    ...
    def pokemon():
        ...
        def Vibes_Events_All_Info_button_4():
            ...
            listbox = Listbox(pikachu,bg="black",highlightthickness=0,bd=0,font=("Consolas",17,"bold"),fg="orange",width=100,height=40)
            ...
            def submitpass():
                ...
                if hoho=="admin":
                    ...
                    def Pupdates():
                        ...
                        Pradeep_K.place(x=2,y=40,width=520,height=530) """
                    ...
                    shubham_y.place(x=10,y=510,width=380,height=70)
                    '''Inside'''
                    def clearit():
                        megapikachuz1.set('')
                        megapikachu2z2.set('')
                    ...
                    preeti.heading('Totalammo',text='Paid Amount')
